...
<?php 
 ...
 $qu12="SELECT * FROM student where email='$usernames' ";
              ...
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <div class="d-lg-flex align-center " >
                    ...
                    <div class="row ml-1 mb-2">
                      <div class="col-sm-12">
                        <a class="btn btn-primary  "  href="login/index_logout.php">logout</a>
                      </div>
                    </div>
                     <div class="row ml-1">
                      <div class="col-sm-12">
                       ...
                       <a class="btn btn-primary  "  href="deletesave.php">Delete account</a>
          ...
          <div class="card-body">
            ...
            <div class="row favourate card" id="favourate">
                <div class='card-body'>
                   <div class='row'>
                     <?php    
                       $qu12="SELECT * from students_joined where  student ='$usernames'";
                     // echo"$qu12";
                      ...
                      ?> 
                              ...
                              <div class='card-body'>
                                 ...
                                 <div class='row'>
                                    <div class='col d-lg-flex flex-row justify-content-between'>
