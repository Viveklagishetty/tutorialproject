...
<div class="total-container">
            ...
            <nav class="navbar shadow-sm bg-white">
              ...
              <div class="navbar-brand" href="#">
                   <img src="images/logo.jpg" alt="" class="rounded" width="40" height="30">
                  Acharya
              </div>
...
<?php
  ...
  ?>  
       ...
       <div class="d-flex">
        <a href="edit_tutor.php">
          <button class="btn-sm btn-primary mx-1 mb-2" style="width: 120px;">Edit</button>
        </a>
        <a href="login/index_logout.php">
          <button class="btn-sm btn-primary mx-1 mb-2" style="width: 120px;">Logout</button>
        </a>
        <a href="deletesave.php">
          <button class="btn-sm btn-primary mx-1 mb-2" style="width: 120px;">Delete account</button>
        </a>
     ...
     <div class="container">
        <div class="card bg-white">
          <div class="card-body">
            ...
            <div class="row">
              <a href="bookings.php" style="color: black; text-decoration: none; width:100%; ">
            ...
            <hr>
                   ...
                   <div class="row">
              <a href="reviewtutor.php" style="color: black; text-decoration: none; width:100%; ">
                <div class="col d-flex justify-content-between">
                ...
                <div class='card-body'>
                   <div class='row'>
                     <?php 
                       ...
                       $qu22="SELECT * from students_joined where   tutor='$usernames' ";
